...
traj = md.load('MD_QMMM_withAB.dcd', top='system_withAB.pdb')

ALA380 = traj.topology.select('resid 379 to 379')
LYS384 = traj.topology.select('resid 383 to 383')
ASP385 = traj.topology.select('resid 384 to 384')
LYS530 = traj.topology.select('resid 529 to 529')
...
plt.xlabel("ATP-IDE-Aβ_residues", fontweight='normal', fontsize=14)
